  ...
  <div>
    ...
    <div class="mint-content">
      ...
      <mt-cell-swipe
        ...
        <div slot="title" class="list-text"><span></span><span>{{item.Province}}{{item.City}}{{item['Street Address']}}{{item['Street Address 2']}}栋{{item['Street Address 3']}}层{{item['Street Address 4']}}</span></div>
      </mt-cell-swipe>
      <button-group>
