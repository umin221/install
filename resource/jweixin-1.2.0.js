!function (e, n) {
  ...
  if (!e.jWeixin) {
    var g = {
      ...
      return e
    }(), S = e.document, v = S.title, y = navigator.userAgent.toLowerCase(), I = navigator.platform.toLowerCase(), _ = !(!I.match("mac") && !I.match("win")), w = -1 != y.indexOf("wxdebugger"), T = -1 != y.indexOf("micromessenger"), k = -1 != y.indexOf("android"), x = -1 != y.indexOf("iphone") || -1 != y.indexOf("ipad"), M = function () {
